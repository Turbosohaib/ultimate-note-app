                ...
                <div className="col-span-5 p-4">
                    ...
                    <div className="flex justify-between items-center py-6 ">
                        ...
                        <div className="flex space-x-2">
                            <svg id="attachement" className="cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="30px" height="26px" viewBox="0 0 24 24">
                    ...
                    <div className="relative w-full">
                        <input type="text" className="text-xl bg-[#f8f2f7] outline-0 focus:ring-1 focus:ring-blue-500 pl-4 pr-10 w-full py-3 border border-gray-300 rounded-md " placeholder="Search file" />
