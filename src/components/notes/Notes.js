      ...
      <div className="grid grid-cols-12 gap-4 h-full">
        <div className="col-span-5 p-4 h-full">
          ...
          <div className="flex justify-between items-center py-6 ">
            <div className="opacity-50">0 notes</div>
            <div className="flex space-x-2 ">
              ...
              >
                <path
                  fill-rule="evenodd"
                  clip-rule="evenodd"
                  d="M12.375 8.925V5.25H6a.75.75 0 00-.75.75v2.925h7.125zm0 1.25H5.25v3.65h7.125v-3.65zm0 4.9H5.25V18c0 .414.336.75.75.75h6.375v-3.675zM6 20a2 2 0 01-2-2V6a2 2 0 012-2h12a2 2 0 012 2v12a2 2 0 01-2 2H6zm7.625-14.75H18a.75.75 0 01.75.75v12a.75.75 0 01-.75.75h-4.375V5.25z"
                  fill="currentColor"
                ></path>
              </svg>
            </div>
          ...
          <div className="py-28">
            ...
            <div className="text-center text-xl opacity-80 py-12">
              <div className="font-bold">Create your first note</div>
              <div>
                Click the
