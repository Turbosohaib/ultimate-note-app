        ...
        <button className="fixed top-0 right-0 m-16 text-xl text-[#6376fe] py-2 px-4 rounded flex items-center space-x-2">
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M12.344 3.285l-8.292 8.301c-.43.431-.816 1.225-1.092 2.004-.277.782-.46 1.6-.46 2.102v.007c0 .138-.001.595.326.924l.014.014.232.158.009.004c.273.152.567.152.671.152h.005c.502 0 1.32-.182 2.102-.458.778-.275 1.573-.66 2.004-1.096l7.707-7.706V7.69l.591-.582.002-.002a2.714 2.714 0 000-3.82h-.001a2.712 2.712 0 00-3.818 0zM3.757 15.7h-.008v-.008c0-.29.13-.95.39-1.684.265-.75.575-1.316.797-1.538l8.289-8.297v-.001a1.462 1.462 0 012.054-.002c.56.568.56 1.484 0 2.052l-.587.579-.005.005-7.708 7.708-.004.004c-.22.222-.784.532-1.532.796-.732.258-1.393.386-1.686.386z"
              fill="#4D64FF"
            ></path>
            <path
              d="M14.687 6.806l-2.06-2.035-.961.963 2.054 2.038.967-.966z"
              fill="#4D64FF"
            ></path>
          </svg>
          Customize
