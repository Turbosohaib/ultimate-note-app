      ...
      <div className="grid grid-cols-12 gap-4 h-full">
        <div className="col-span-5 p-4">
          ...
          <div className="flex justify-between items-center py-6 opacity-50">
            <div className="py-8 text-xl">0 notes</div>
            <div className="flex gap-2">
              <div>
                <button>
                  <svg
                    className="hover:bg-gray-200 rounded-[5px] p-[3px]"
                    width="35"
                    height="35"
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div>
                <button
                  type="button"
                  className="hover:bg-gray-200 p-[3px] rounded-[5px]"
                >
                  <svg
                    width="30"
                    height="26"
          ...
          <div className="py-28">
            ...
            <div className="text-center text-xl">
              ...
              <div>
                ...
                button in the sidebar to <br></br> create a note.
              </div>
            </div>
          </div>
        </div>
