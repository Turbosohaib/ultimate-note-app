        ...
        <div className="py-8 px-6">
            ...
            <div className="">
                ...
                <div className="grid font-semibold grid-cols-12 px-3 py-2 text-[18px] opacity-80 border-b border-solid border-gray-300">
                    <div className="col-span-4 flex items-center space-x-2  font-semibold">
                        <Link href="/first_note_book" className="flex gap-1 hover:underline">
                            <svg className="hover:rotate-90" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.78 11.47a.75.75 0 010 1.06l-4.5 4.5a.75.75 0 11-1.06-1.06L14.19 12l-3.97-3.97a.75.75 0 111.06-1.06l4.5 4.5z" fill="#737373"></path></svg>
                            <svg width="30" height="26" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="qg__LKkPtlEMXwZkz0lP"><g fill-rule="evenodd" clip-rule="evenodd" fill="#737373"><path d="M3.75 2.5v15h10.208a2.292 2.292 0 002.292-2.292V4.792A2.292 2.292 0 0013.958 2.5H3.75zm3.748 1.25v12.5h6.46c.576 0 1.042-.466 1.042-1.042V4.792c0-.576-.466-1.042-1.042-1.042h-6.46zM5 16.25V3.75h1.248v12.5H5z"></path><path d="M13.505 7.697a.75.75 0 01-.75.75h-3a.75.75 0 110-1.5h3a.75.75 0 01.75.75z"></path></g></svg>
                            First Notebook 1
                        </Link>
                    ...
                    <div className="col-span-1 text-end "><span>-</span></div>
                    <div className="col-span-3 text-end">
                        <button type="button" className="hover:bg-gray-300 p-[3px] rounded-[5px]">
                            <svg width="25" height="25" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clipRule="evenodd" d="M16 12c0 1.1.9 2 2 2s2-.9 2-2-.9-2-2-2-2 .9-2 2zm-2 0c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2zm-6 0c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2z" fill="currentColor"></path></svg>
                        </button>
                    </div>
                </div>
            </div>
